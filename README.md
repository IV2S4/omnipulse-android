...
The current MVP includes a Material 3 app shell, an interactive social feed, a vertically paged short-form Clips experience, and local 1:1 messaging with searchable conversations and functional threads. See [PROGRESS.md](PROGRESS.md) for the completed scope and next slice.
