...
The current MVP includes a Material 3 app shell, an interactive social feed, a vertically paged short-form Clips experience, and stateful local 1:1 messaging with search, unread state, drafts, and sending. See [PROGRESS.md](PROGRESS.md) for the completed scope and next slice.
